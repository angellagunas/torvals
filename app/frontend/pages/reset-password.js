      ...
      <div className="LogIn single-form">
        <div className="card">
          <header className="card-header">
            <p className="card-header-title">Restabler contraseña</p>
          ...
          <div className="card-content">
            <div className="content">
              <p>
                Necesitamos tu dirección de correo para enviarte un link de
              ...
              >
                ...
                <div className={this.state.apiCallMessage}>
                  <div className="message-body is-size-7 has-text-centered">
                    El e-mail ha sido enviado. El link tendrá una vigencia de 10
                    dias.
                  </div>
                </div>
