    ...
    return (
      <div className="section pad-sides has-20-margin-top catalogs">
        ...
        <p className="subtitle is-6">
          Selecciona los campos con los que cuentan tus ventas o catálogos.
        </p>
          ...
          <div className="column">
            <div className="field">
              ...
              <div className="control">
                <input
                  className="input"
                  type="text"
                  placeholder="Agregar nuevo catálogo"
                  value={this.state.addCatalog}
                  onKeyDown={e => {
                    this.addUserCatalog(e);
                  }}
                  onChange={e => {
                    this.setState({ addCatalog: e.target.value });
                  }}
                />
              </div>
            </div>
            ...
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Selecciona campos</p>
              </header>
                          ...
                          <div className="control">
                            <Checkbox
                              ...
                              handleCheckboxChange={(e, value) =>
                                this.handleCheckboxChange(value, item)
                              }
                              ...
                              <DeleteButton
                                ...
                                message={
                                  <span>
                                    ...
                                    Catálogo?
                                    <br /> Los elementos de éste catálogo ya no
                                    estarán disponibles
                                  </span>
                                }
                                small
