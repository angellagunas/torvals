      ...
      <div>
        <div className="calendar">
          <div className="calendar-nav">
            ...
            <div className="calendar-month is-capitalized">
              ...
              {this.state.calendarDays &&
                this.state.calendarDays.map((item, key) => {
                  if (item.value !== 0) {
                    ...
                    let isAdjustmentLimit =
                      this.props.limits &&
                      this.props.limits.rangeAdjustment.indexOf(date) !== -1;

                    let isApproveLimit =
                      this.props.limits &&
                      this.props.limits.rangeAdjustmentRequest.indexOf(date) !==
                        -1;
                    ...
                    return (
                      <div
                        ...
                        className={classNames('calendar-date', {
                          ...
                          'calendar-range calendar-range-sales':
                            this.props.limits &&
                            date2.isBetween(
                              this.props.limits.startDates[
                                this.state.date.get('month')
                              ],
                              this.props.limits.salesUpload[
                                this.state.date.get('month')
                              ],
                              'days',
                              '()'
                          ...
                          'calendar-range calendar-range-forecast':
                            ...
                            date2.isBetween(
                              ...
                              this.props.limits.forecastCreation[
                                this.state.date.get('month')
                              ],
                              'days',
                              '()'
                          ...
                          'calendar-range calendar-range-adjustments':
                            ...
                            date2.isBetween(
                              ...
                              this.props.limits.rangeAdjustment[
                                this.state.date.get('month')
                              ],
                              'days',
                              '()'
                          ...
                          'calendar-range calendar-range-approve':
                            ...
                            date2.isBetween(
                              ...
                              this.props.limits.rangeAdjustmentRequest[
                                this.state.date.get('month')
                              ],
                              'days',
                              '()'
                      ...
                      >
                        <button
                          onClick={() => {
                            this.selectDay(item, 'inicio');
                          }}
                          className={classNames('date-item', {
                            'is-today':
                              this.props.today &&
                              this.props.today.format('YYYY-MM-DD') === date,
