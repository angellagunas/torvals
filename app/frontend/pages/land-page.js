      ...
      <div className="landing">
        <div className="left-side">
          <div className="down">
            ...
            <br />
            <h2 className="has-text-white is-size-4-desktop is-size-5-touch">
              Nuestra misión es dar cognición sistemática a las organizaciones
            </h2>
          </div>
        </div>
              ...
              <nav className="navbar is-bg-white">
                <div className="navbar-brand">
                  <Link to="/landing" className="navbar-item grey-hover">
                    <img
                      className="is-flex r-pad"
                      src="/app/public/img/orax-logo.svg"
                    />
                    <h3 className="is-size-4 is-capitalized has-text-weight-semibold">
                      Orax
                    </h3>
                  </Link>
                </div>
            ...
            <div className="hero-body">
              <div className="has-text-centered">
                <h1 className="title has-text-color is-size-2-desktop is-size-3-touch pad-bottom">
                  Toma de decisiones de operación <br />a partir de predicción
                  de comportamiento de venta
                </h1>
                      ...
                      <div className="card card-land">
                        ...
                        <div className="card-content">
                          <div className="content">
                            <p className="has-text-danger is-size-5 has-text-weight-semibold is-padding-bottom-small">
                              Predicción
                            </p>
                      ...
                      <div className="card card-land">
                        ...
                        <div className="card-content">
                          <div className="content">
                            ...
                            Ajusta la orden de acuerdo a la predicción y
                            existencias.
                          </div>
                        </div>
                      </div>
