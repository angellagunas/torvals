...
class ConfigureDatasetForm extends Component {
  ...
  handleChangeCheckbox(type, event) {
    ...
    var posColumn = this.state.formData.columns.findIndex(e => {
      return String(e.name) === String(column[0]);
    });
  ...
  handleChangeSelect(type, event) {
    ...
    var actualColumnIndex = state.formData.columns.findIndex(e => {
      return String(e.name) === String(column);
    });

    const previousColumn = state.formData.columns.find(item => {
      return item[type];
    });

    if (previousColumn) {
      var posNameColumn = state.formData.columns.findIndex(e => {
        return String(e.name) === String(previousColumn.name);
      });
  ...
  getValue(type) {
    let item = this.state.formData.columns.find(item => {
      return item[type];
    });
                    ...
                    <select
                      ...
                      className={
                        this.state.errors['isDate']
                          ? 'is-fullwidth select-is-danger'
                          : 'is-fullwidth'
                      }
                      onChange={e => {
                        this.handleChangeSelect('isDate', e);
                      }}
                    >
                ...
                <div className="control">
                  <div className="select is-fullwidth">
                    <select
                      ...
                      onChange={e => {
                        this.handleChangeSelect('isAnalysis', e);
                      }}
                    >
                      <option value="">Selecciona una opción</option>
                      {this.state.formData.columns.map(function(item, key) {
                ...
                <div className="control">
                  <div className="select is-fullwidth">
                    <select
                      ...
                      onChange={e => {
                        this.handleChangeSelect('isAdjustment', e);
                      }}
                    >
                      <option value="">Selecciona una opción</option>
                      {this.state.formData.columns.map(function(item, key) {
                ...
                <div className="control">
                  <div className="select is-fullwidth">
                    <select
                      ...
                      onChange={e => {
                        this.handleChangeSelect('isPrediction', e);
                      }}
                    >
                      <option value="">Selecciona una opción</option>
                      {this.state.formData.columns.map(function(item, key) {
            ...
            <div className="control">
              <div className="select is-fullwidth">
                <select
                  ...
                  onChange={e => {
                    this.handleChangeSelect('isSales', e);
                  }}
                >
                  <option value="">Selecciona una opción</option>
                  {this.state.formData.columns.map(function(item, key) {
                    ...
                    <div className="control">
                      <div className="select is-fullwidth">
                        <select
                          ...
                          onChange={e => {
                            this.handleChangeSelect(item.id.name, e);
                          }}
                        >
                          <option value="">Selecciona una opción</option>
                          {this.state.formData.columns.map(function(item, key) {
                    ...
                    <div className="control">
                      <div className="select is-fullwidth">
                        <select
                          ...
                          onChange={e => {
                            this.handleChangeSelect(item.name.name, e);
                          }}
                        >
                          <option value="">Selecciona una opción</option>
                          {this.state.formData.columns.map(function(item, key) {
              ...
              <div key={key} className="columns has-borders">
                ...
                <div className="column is-3 has-text-centered">
                  <label className="checkbox">
                    <input
                      type="checkbox"
                      checked={this.getValueForColumn(
                        item.name + '|isOperationFilter'
                      )}
                      onChange={e => {
              ...
              <div className="field is-narrow">
                <div className="control">
                  <div className="select is-fullwidth">
                    <select
                      onChange={e => {
                        this.handleChangeGroupings('groupingColumn', e);
                      }}
                    >
              ...
              <div className="field">
                <p className="control is-expanded">
                  <input
                    ...
                    onChange={e => {
                      this.handleChangeGroupings('groupingInput', e);
                    }}
                  />
                </p>
              </div>
              <div className="field">
                <p className="control is-expanded">
                  <input
                    ...
                    onChange={e => {
                      this.handleChangeGroupings('groupingOutput', e);
                    }}
                  />
                </p>
              </div>
