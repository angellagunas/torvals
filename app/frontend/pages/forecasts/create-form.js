...
class ForecastForm extends Component {
  ...
  handleColumnsForForecastValues(event) {
    ...
    if (!this.state.columnForForecast) {
      ...
      this.setState({
        ...this.state.formData.columnsForForecast.push(
          this.state.columnForForecast
        ),
        columnForForecast: undefined,
      });
    }
  ...
  getDateEnd() {
    if (this.state.dateStart && !this.state.dateEnd) {
      return moment(this.state.dateStart)
        .add(1, 'months')
        .subtract(1, 'days');
    }
              ...
              <div className="field">
                <p className="control is-expanded">
                  <input
                    ...
                    onChange={e => {
                      this.handleChange('holidaysName', e.currentTarget.value);
                    }}
                  />
                </p>
              </div>
              <div className="field has-addons">
                <div className="control is-expanded is-datepicker-fullwidth">
                  <DatePicker
                    ...
                    onChange={e => {
                      this.handleChange('holidaysDate', e);
                    }}
                  />
                </div>
                <div className="control">
