...
class ForecastDetail extends Component {
  ...
  async loadPredictions() {
    ...
    setTimeout(() => {
      this.setState({ reloadPredictions: false });
    }, 100);
  }
  /*
   * Endpoints Call
    ...
    return [
      {
        ...
        sortable: true,
        formatter: row => {
          return <Link to={'/datasets/detail/' + row.uuid}>{row.name}</Link>;
        },
      },
      {
        title: 'Status',
      ...
      },
      {
        ...
        formatter: row => {
              ...
              <div className="field is-grouped">
                <div className="control">
                  <button
                    ...
                    onClick={() => {
                      this.approveRequestOnClick(row.uuid);
                    }}
                  >
                    Aprobar
                  </button>
                ...
                <div className="control">
                  <button
                    ...
                    onClick={() => {
                      this.rejectRequestOnClick(row.uuid);
                    }}
                  >
                    Rechazar
                  </button>
          ...
          if (row.status === 'approved') {
            return (
              <span>
                <span style={{ paddingRight: '5px' }}>Approved by:</span>
          ...
          if (row.status === 'rejected') {
            return (
              <span>
                <span style={{ paddingRight: '5px' }}>Rejected by:</span>
  ...
  handleGraphFilters(e) {
    ...
    if (e.target.value) {
      graphDataFiltered = this.state.forecast.graphData.filter(
        item => item.producto_id === e.target.value
      );
    }
      ...
      return (
        <div className="card">
          <header className="card-header">
            <p className="card-header-title">Predictions</p>
          </header>
          <div className="card-content">
            <div className="message is-success">
              <div className="message-body is-large has-text-centered">
                ...
                <div className="columns">
                  <div className="column">
                    The predictions will appear shortly... They are being
          ...
          <div className="card-content">
            <div className="message is-danger">
              <div className="message-body is-large has-text-centered">
                ...
                <div className="columns">
                  <div className="column">
                    There was an error while processing the forecast, please
      ...
      <div>
        ...
        <div className="columns">
          <div className="column">
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Predictions Table</p>
              </header>
    ...
    return (
      <div className="columns">
        <div className="column">
          <div className="card">
            <header className="card-header">
              <p className="card-header-title">Datasets</p>
            </header>
            <div className="card-content">
              <div className="columns">
                <div className="column">
  ...
  async approveRequestOnClick(uuid) {
    ...
    const adjustmentRequests = await api.get('/app/adjustmentRequests/', {
      ...
      return (
        <div className="columns">
          <div className="column">
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Adjustment Requests</p>
              </header>
              <div className="card-content">
                <div className="columns">
                  <div className="column">
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <header className="card-header">
            <p className="card-header-title">
              Forecast from{' '}
              {moment.utc(forecast.dateStart).format('DD/MM/YYYY')} to{' '}
            ...
            <div className="field is-grouped is-grouped-right card-header-select">
              ...
              <div className="control">{this.getButtons()}</div>
              <div className="control">
                <a
        ...
        <ToastContainer />
        <div
          className="columns c-flex-1 is-marginless"
          style={{ overflowY: 'scroll', height: this.state.bodyHeight }}
        >
