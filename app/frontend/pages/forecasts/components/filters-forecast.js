          ...
          <form className="is-fullwidth">
            <div className="columns is-multiline">
                      ...
                      <div className="control">
                        <div className="select is-fullwidth">
                          <select
                            ...
                            onChange={e =>
                              this.handleFilters(e, 'salesCentersSelected')
                            }
                          >
                            <option value="" />
                            {this.state.salesCentersOptions.enumOptions.map(
                              (item, index) => {
                                return (
                      ...
                      <div className="control">
                        <div className="select is-fullwidth">
                          <select
                            ...
                            onChange={e =>
                              this.handleFilters(e, 'productsSelected')
                            }
                          >
                            <option value="" />
                            {this.state.productsOptions.enumOptions.map(
                              (item, index) => {
                                return (
                    ...
                    <div className="field">
                      <div className="control">
                        <div className="select is-fullwidth">
                          <select
                            className="is-fullwidth"
                            value={this.props.channel.value}
                            onChange={e =>
                              this.handleFilters(e, 'channelSelected')
                            }
                          >
                            <option value="" />
              ...
              <div className="column is-12">
                <div className="tabs is-boxed">{this.getDays()}</div>
              </div>
            </div>
          </form>
        </div>
