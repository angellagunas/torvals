...
export function DownloadWidget({ url, minMonth, maxMonth, project = {} }) {
  return (
    <a href={url} download={project.name} className="card download-card">
      ...
      <div className="download-icon">
        <img
          width="40px"
          src="/app/public/img/download.svg"
          alt="download icon"
        />
      </div>
    </a>
...
class DownloadReport extends Component {
  ...
  async getData() {
    try {
      ...
      moment.locale('es');
      data.forEach(item => {
        item.minMonth = this.capitalize(
          moment.utc(item.minDate).format('MMMM')
        );
        item.maxMonth = this.capitalize(
          moment.utc(item.maxDate).format('MMMM YYYY')
        );
          ...
          <div className="columns filters-project">
            ...
            <div className="column">
              ...
              <div className="has-text-info">
                ...
                Recuerda que tus reportes estan disponibles 24 horas despues de
                tu cierre.
              </div>
