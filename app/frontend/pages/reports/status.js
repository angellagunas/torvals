...
class StatusRepórt extends Component {
  ...
  async getFilters() {
    ...
    try {
      ...
      let cycles = _.orderBy(res.cycles, 'dateStart', 'asc').map(item => {
        return {
          ...item,
          name:
  ...
  async getUsers() {
    ...
    try {
      let res = await api.post(url, {
        users: this.state.formData.user
  ...
  async getDataRows() {
    ...
    try {
      ...
      let users = this.state.formData.user
        ? [this.state.formData.user]
        : undefined;
        ...
        formatter: row => {
          return (
            <a
              ...
              onClick={() => this.userDetail(row.user[0])}
            >
      ...
      <div className="status-report">
        ...
        <div className="section columns is-padingless-top">
          <div className="column is-3">
            <div
              className={classNames('notification is-success filter-widget', {
              ...
              <div className="level">
                <div className="level-left">
                  ...
                  <div className="level-item">
                    <p>
                      <strong>
                        {this.state.users.finishedUsers.length} Usuarios
                      </strong>
                    </p>
          ...
          <div className="column is-3">
            <div
              className={classNames('notification is-info filter-widget', {
              ...
              <div className="level">
                <div className="level-left">
                  ...
                  <div className="level-item">
                    <p>
                      <strong>
                        {this.state.users.inProgressUsers.length} Usuarios
                      </strong>
                    </p>
          ...
          <div className="column is-3">
            <div
              className={classNames('notification is-danger filter-widget', {
              ...
              <div className="level">
                <div className="level-left">
                  ...
                  <div className="level-item">
                    <p>
                      <strong>
                        {this.state.users.inactiveUsers.length} Usuarios
                      </strong>
                    </p>
                    <p>Sin ajustes</p>
                  </div>
              ...
              <section className="section">
                <center>
                  <h1 className="has-text-info">
                    No hay información que mostrar, intente con otro filtro
                  </h1>
                </center>
              </section>
            )
          ) : (
            <section className="section">{this.loadTable()}</section>
          )}
        </div>
      </div>
    );
