...
export default function (options = {}) {
  class ListPage extends Component {
    ...
    async setSalesCenter(value) {
      //FIXME: datos que debemos filtrar + filtrado + insercion y paginado de los datos filtrados (?)
      // const { pageLength } = this.state
      ...
      // const filteredData = value === null ? [] : data.filter(item => {
      //   if(item.catalogItems[1].uuid === value.value){
      //     return item
      //   }
      // })
      ...
      const { filters } = this.state
      const centro = value === null ? '' : value.label
    ...
    //FIXME: este componente no hace nada por el momento
    clearSearch() {
      this.setState({
        salesCenter: ""
      })
          ...
          <div className="field">
            <div className="control has-icons-right">
              <input
                ...
                type="text"
                // value={filters.general || filters.name}
                value={filters.name}
              ...
              <div className="level">
                ...
                <div className="level-right has-20-margin-top">
                  <div className="level-item field is-grouped is-grouped-right">
                    {/* TODO: Get component working properly | Selector/Filtro de Centros de Ventas */}
