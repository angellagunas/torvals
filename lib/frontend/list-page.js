...
export default function (options = {}) {
  class ListPage extends Component {
    ...
    setSalesCenter(value) {
      //FIXME: datos que debemos filtrar
      const pricesComponent = this.context.tree.get(options.branchName)
      console.log('options.branchName', pricesComponent)
      const data = pricesComponent.items
    ...
    generalSearchOnChange(e) {
      ...
      console.log(this.state.filters.general)
    }
              ...
              <div className="level">
                ...
                <div className="level-right has-20-margin-top">
                  <div className="level-item field is-grouped is-grouped-right">
                    {/* FIXME: get the selector showing */}
