...
class SelectOrganizationForm extends Component {
  ...
  async submitHandler ({formData}) {
    ...
    cookies.set('organization', formData.organization)
  ...
  render () {
    ...
    schema.properties.organization.enum = user.organizations.map(item => { return item.organization.slug })
    schema.properties.organization.enumNames = user.organizations.map(item => { return item.organization.name })
