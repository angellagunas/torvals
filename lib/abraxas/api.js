...
const postProject = async function (uuid, organization) {
  const api = await apiData()
...
const comparationProject = async function (externalId, bodyRequest) {
  const api = await apiData()

  var options = {
    url: `${api.hostname}${api.baseUrl}/comparation/projects/${externalId}`,
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
...
const filterProject = async function (externalId, dateMax, dateMin) {
  const api = await apiData()
...
const uploadDataset = async function (projectId, body) {
  const api = await apiData()

  var options = {
    url: `${api.hostname}${api.baseUrl}/projects/${projectId}/datasets/upload_and_process`,
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
...
const rowsDataset = async function (externalId, page = 1, pageSize = 5000) {
  const api = await apiData()
...
const comparationOrganization = async function (externalId, bodyRequest) {
  const api = await apiData()

  var options = {
    url: `${api.hostname}${api.baseUrl}/comparation/organizations/${externalId}`,
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
...
const graphicOrganization = async function (externalId, bodyRequest) {
  const api = await apiData()

  var options = {
    url: `${api.hostname}${api.baseUrl}/graphic/organizations/${externalId}`,
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
