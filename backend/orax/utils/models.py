...
class TimeStampedMixin(models.Model):
    """
    Defines the auto populated 'created_date' and 'last_modified' fields.
    ...
    class Meta:
        """Define if this models is abstract."""
...
class CatalogueMixin(TimeStampedMixin):
    """
    Defines name, is active and extends from TimeStampedMixin.
