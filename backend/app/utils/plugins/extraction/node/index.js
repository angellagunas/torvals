...
const run = async xmlPath => {
  ...
  const params = {
    ...
    queries: [
      {
        query: defaultQueries.queryAlma("2019-08-18", "2019-08-18"),
        tableName: "recorridos_20190818",
        primaryColumns: ["CLICOD", "codigo_agencia"],
        filePrefix: "recorridos_20190818"
      }
    ],
    keyspace: "dsd",
...
run("/home/al/Downloads/agencias_piloto.xml");
